package com.example.galor_nadav_hw1.compass;
import android.content.Context;

import com.example.galor_nadav_hw1.R;
...
public class SOTWFormatter {
    ...
    // the difference between the target and both values. It assumes that val2 is greater
    // than val1 and target lies between these two.
